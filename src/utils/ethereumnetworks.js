const networks = [{
    ...
    "chain": "fuji",
    "network": "testnet",
    "networkId": 43113, "nativeCurrency": {"name": "AVAX Coin", "symbol": "AVAX", "decimals": 18},
    ...
    "network": "mainnet",
    "networkId": 1891,
    "nativeCurrency": {"name": "QuiKnot", "symbol": "KNOT", "decimals": 18},
    "rpc": ["http://nc2.quipu.network", "https://nc2.quipu.network", "https://nc3.quipu.network"],
    "faucets": [],
    "infoURL": "https://explorer.quipu.network/"
}]
...
export {
    ExplainNetworkById, GetMetaNetConfig
}
